...
sh $MACOS_DIR/name.sh

# Apply dock settings
sh $MACOS_DIR/dock.sh

# Apply trackpad settings
sh $MACOS_DIR/trackpad.sh

# Apply Finder settings
sh $MACOS_DIR/finder.sh

# Apply Spotlight settings
sh $MACOS_DIR/spotlight.sh

# Kill all applications affected by changed settings
sh $MACOS_DIR/killall.sh
